...
- viii. All cases have a time limit, if not resolved in that time the defendent is declared innocent. Time limits are as follows:  Magesterial court - 10 Days; Senatorial Court - 15 Days; High Court - 20 Days.
## e. Fixing Issues
...
- ii. External Organizations are prohibited from holding any power over HL, all actions by External Organizations concerning HL, Hellenes, the General Assembly, and their respective members must be reported to the senate.
# 4. Distribution
